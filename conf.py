...
BLOG_AUTHOR = "enigma"  # (translatable)
BLOG_TITLE = "expdemos"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://expdemos.com/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://expdemos.com/"
BLOG_EMAIL = "jiancheng.pro@gmail.com"
BLOG_DESCRIPTION = "experiment demos & presentation"  # (translatable)
